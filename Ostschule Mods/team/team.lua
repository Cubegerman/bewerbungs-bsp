...
minetest.register_privilege("d5", {
    description = "Klasse 5d priv"
})
...
local function set_nametag(name)
    ...
    if player then  --immer true 
        ...
        elseif privs.d5 then
            player:set_nametag_attributes({color = "0xFF000000", text = string.char(0x1b).."(c@#00ff00)[5d]"..string.char(0x1b).."(c@#ffffff) "..name})
